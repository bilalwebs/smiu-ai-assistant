...
export default function ChatPage() {
  ...
  const handleAttach = async (file: File) => {
    ...
    setError(null);
    try {
      const result = await api.documents.uploadStandalone(file);
    ...
    <div className="flex h-full flex-col">
      ...
      <div className="flex items-center gap-3 border-b border-border bg-surface px-4 py-3">
        <button
          ...
          className="flex h-8 w-8 items-center justify-center rounded-lg text-text-secondary hover:bg-muted lg:hidden"
          aria-label="Back"
        >
