"""Groq adapter for the LLM gateway (AI_ARCHITECTURE.md §35).

Wraps the ``groq`` SDK behind ``LLMGateway``. The SDK client is injected at
...
class GroqGateway(LLMGateway):
    """Gateway adapter for Groq chat completions (§35.1)."""
